...
public abstract class BaseEntity {
	...
	public int save() throws Exception {
		...
		if (params.size() == 0) {
			...
			r = dbutil.insert(sql, params.toArray());
		}
		return r;
	}
	...
	public int update() throws Exception {
		...
		if (params.size() == 0) {
			...
			r = dbutil.update(sql, params.toArray());
		}
		return r;
	}
	...
	public List query() throws Exception {
		...
		String sql = sql1;
		List r = dbutil.query(getClass(), sql, params.toArray());
		return r;
	}
	...
	public int delete() throws Exception {
		...
		int r = dbutil.update(sql, new Object[] { param });
		return r;
	}
